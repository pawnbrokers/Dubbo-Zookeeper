---
title: SpringBoot整合Dubbo+Zookeeper
date: 2020-05-14 21:18:25
tags:
...
Github:https://github.com/pawnbrokers/Dubbo-Zookeeper

转载：狂神说 https://mp.weixin.qq.com/s/sKu9-vH7NEpUd8tbxLRLVQ
...
1. 启动zookeepwe-server（保持常开）

2. 打包dubbo-admin，主要是可视化监控功能
...
3. 引入依赖
   ...
   4. Provider类中的application.properties配置
      + 当前应用的名字
      + 注册中心的地址（默认端口为2181）
      + 指定扫描包下的服务
...
5. 在Service的实现类中配置服务注解，发布服务，**注意导包问题！！！**

```java
import org.apache.dubbo.config.annotation.Service;
import org.springframework.stereotype.Component;

@Service //将服务发布出去,这里并非spring的service注解
@Component //放在容器中
public class TicketServiceImpl implements TicketService {
   @Override
   public String getTicket() {
...
6. 服务消费者同样导入依赖
7. 消费者的application.properties中**配置当前应用的名字和注册中心的地址，这里我们并没有发布服务，所以不用配置此项**
...
![image-20200514213644013](I:\blog\source\_posts\SpringBoot整合Dubbo-Zookeeper.assets\image-20200514213644013.png)
